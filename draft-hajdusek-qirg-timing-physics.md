...
~~~
{: #hom-interference title="HOM interference of two photons."}
...
The memory is then excited by a laser pulse of ~ `dollarsign50\mu \text{s}dollarsign` that generates a photon.
